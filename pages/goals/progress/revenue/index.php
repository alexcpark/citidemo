<?php include '../../../../includes/header-meta.php'; ?>
	...
	<body id="bv-page-goals" class="page1-subpage3">
		...
		<?php include '../../../../includes/header-program-goals.php'; ?> 
				    ...
				    <div class="content">
						<div class="main-section" style="display: block;">
					        <div class="container">
					          <div class="main-section-title">Progress &nbsp;>&nbsp; Revenue</div>
					          <div class="row">
					            <div class="span8">
								  <div class="main-section-block-title">Insights &amp; Steps&colon; Weekly Revenue</div>
