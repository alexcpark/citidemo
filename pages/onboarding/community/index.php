<?php include '../../../includes/header-meta.php'; ?>
	...
	<body id="bv-page-onboarding" class="page2">
					        ...
					        <div class="container">
					          ...
					          <div class="row">
					            <div class="span8">
					              ...
					              <!-- BVVIZ - Onboarding -->
								  <div class="main-section-block-title">All Recent Activity in Onboarding @ Bank Digital</div>
								  <div id="BVVIZ-onboarding_community0_siteStream" class="bvviz-container"></div>
								</div>
					          </div><!-- /.row -->
					        </div><!-- /.container -->
					    </div><!-- /.main-section -->
