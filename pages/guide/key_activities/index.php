		...
		<?php include '../../../includes/header-program-guide.php'; ?> 
				    ...
				    <div class="subnav">
				    	<ul class="subnav-pages">
							...
							<li class="subnav-page"><a href="/pages/guide/key_activities/?program_id=1&player_id=5643c424a33c43d250002cb5" class="active" >Key Activities</a></li>
				    	</ul>
				    </div>
					<!-- END PROGRAM SUB NAV -->
					          ...
					          <div class="row">
					            <div class="span8">
								  <div class="main-section-block-body main-section-block-break">
						              ...
						              <p class="main-section-block-break">Progress is a cumulative measure of unfinished goals your pursuing or tasks that aren’t complete. Progress is built from activities you perform over time. When you visit the Reputation Center, activities are tallied up to assess and visualize your progress since your last visit. Of all possible activities, some are usually more valuable to you than others.</p>
