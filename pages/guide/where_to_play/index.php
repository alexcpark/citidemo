					          ...
					          <div class="row">
					            <div class="span8">
								  <div class="main-section-block-body main-section-block-break">
									  ...
									  <p class="main-section-block-break2">Well, In lieu of getting access to an official Bank Digital application, we did the next best thing&colon; we built our own! Introducing &quot;<span class="bv-bold">Bank Net</span>,&quot; a mock intranet created by Badgeville to power your demo experience. In it, employee &quot;tasks&quot; are emulated. From there, you can perform these activities live and then see your results in your personal Reputation Center (an external collection of visualizations). You can also see results inside some applications natively. These applications allow for direct embedding of our smaller widget-style visualizations (i.e. Sharepoint and Salesforce). </p>
									  <p class="main-section-block-title">Where do I start?</p>
									  <p class="">Bank Net and the Reputation center are your first stops for gamification. Here&apos;s a full description of each asset provided with this demo&colon;</p>
									  <ul class="main-section-block-list">
									  	<li><span class="bv-bold">Sharepoint (as the mock intranet, &quot;Bank Net&quot;)</span> - Location for learning and onboarding content. Includes visualizations.</li>
