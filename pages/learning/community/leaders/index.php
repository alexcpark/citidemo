<?php include '../../../../includes/header-meta.php'; ?>
	...
	<body id="bv-page-learning" class="page2-subpage2">
		...
		<?php include '../../../../includes/header-program-learning.php'; ?> 
				    ...
				    <div class="content">
						<div class="main-section" style="display: block;">
					        <div class="container">
					          <div class="main-section-title">Learning Community &nbsp;>&nbsp; Leaders</div>
					          <div class="row">
					            <div class="span8">
					              ...
					              <!-- BVVIZ - Goals -->
								  <div id="BVVIZ-learning_community2_leaderboardLeaders" class="bvviz-container"></div>
								</div>
					          </div><!-- /.row -->
					        </div><!-- /.container -->
					    </div><!-- /.main-section -->
