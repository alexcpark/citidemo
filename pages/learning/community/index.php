		...
		<?php include '../../../includes/header-program-learning.php'; ?> 
				    ...
				    <div class="subnav">
				    	<ul class="subnav-pages">
							...
							<li class="subnav-page"><a href="/pages/learning/community/?program_id=1&player_id=5643c424a33c43d250002cb5" class="active" >Community</a>
								<ul class="subnav-subpages">
					        ...
					        <div class="container">
					          ...
					          <div class="row">
					            <div class="span8">
								  ...
								  <div id="bvviz-siteStream-3" class="bvviz-container"></div>
								</div>
					          </div><!-- /.row -->
					        </div><!-- /.container -->
					    </div><!-- /.main-section -->
