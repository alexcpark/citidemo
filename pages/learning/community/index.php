<?php include '../../../includes/header-meta.php'; ?>
	...
	<body id="bv-page-learning" class="page2">
					        ...
					        <div class="container">
					          ...
					          <div class="row">
					            <div class="span8">
					              ...
					              <!-- BVVIZ - Goals -->
								  <div class="main-section-block-title">All Recent Activity in Learning @ Bank Digital</div>
								  <div id="BVVIZ-learning_community0_siteStream" class="bvviz-container"></div>
								</div>
					          </div><!-- /.row -->
					        </div><!-- /.container -->
					    </div><!-- /.main-section -->
