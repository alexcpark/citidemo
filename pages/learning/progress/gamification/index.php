		...
		<?php include '../../../../includes/header-program-learning.php'; ?> 
				    	...
				    	<ul class="subnav-pages">
							<li class="subnav-page"><a href="/pages/learning/progress/?program_id=1&player_id=5643c424a33c43d250002cb5" class="" >Progress</a>
								<ul class="subnav-subpages">
									<li class="subnav-subpage"><a href="/pages/learning/progress/products/?program_id=1&player_id=5643c424a33c43d250002cb5" class="" >Products</a></li>
									...
									<li class="subnav-subpage"><a href="/pages/learning/progress/gamification/?program_id=1&player_id=5643c424a33c43d250002cb5" class="active" >Gamification</a></li>
								</ul>
							</li>
				    ...
				    <div class="content">
						<div class="main-section" style="display: block;">
					        <div class="container">
					          <div class="main-section-title">Progress &nbsp;>&nbsp; Gamification</div>
					          <div class="row">
					            <div class="span8">
								  <div class="main-section-block-body main-section-block-break">
									  <p>Looking to cement your reputation in Wealth Management? Complete this learning unit to solidify your expertise with this subject area.</p>
								  </div>
					              <!-- BVVIZ - Collaboration -->
								  <div id="bvviz-missionProgress-9" class="bvviz-container main-section-block-break"></div>
								</div>
					          </div><!-- /.row -->
					        </div><!-- /.container -->
					    </div><!-- /.main-section -->
