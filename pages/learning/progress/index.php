<?php include '../../../includes/header-meta.php'; ?>
	...
	<body id="bv-page-learning" class="page1">
					        ...
					        <div class="container">
					          ...
					          <div class="row">
					            <div class="span8">
					              ...
					              <!-- BVVIZ - Goals -->
								  <div class="main-section-block-title">Your activity in Learning</div>
								  <div id="BVVIZ-learning_progress0_playerStream" class="bvviz-container"></div>
								</div>
					          </div><!-- /.row -->
					        </div><!-- /.container -->
					    </div><!-- /.main-section -->
