<?php include '../../../../includes/header-meta.php'; ?>
	...
	<body id="bv-page-collaboration" class="page2-subpage1">
		...
		<?php include '../../../../includes/header-program-collaboration.php'; ?> 
				    ...
				    <div class="content">
						<div class="main-section" style="display: block;">
					        <div class="container">
					          <div class="main-section-title">Collaboration Community &nbsp;>&nbsp; Leader</div>
					          <div class="row">
					            <div class="span8">
					              ...
					              <!-- BVVIZ - Onboarding -->
								  <div class="main-section-block-title">Where You Stand</div>
								  <div id="BVVIZ-collaboration_community2_leaderboardLeaders" class="bvviz-container"></div>
								</div>
					          </div><!-- /.row -->
					        </div><!-- /.container -->
					    </div><!-- /.main-section -->
