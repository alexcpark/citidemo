...
BVVIZ.playerProfile = function( target, playerId, options ) {
  ...
  unitBarSettings = $.extend( { visualization : 'playerProfile' }, settings.unitBar ),
  ...
  function init() {
    ...
    var nav = $( '<div class="bvviz-body-header"></div>' ).append(
                render.nav()
              );
  ...
  function show( method ) {
    ...
    case 'rewards':
      ...
      BVVIZ.playerRewards( newCards, playerId, true );
      break;
    ...
    case 'missions':
      ...
      BVVIZ.playerMissions( newCards, playerId, true );
      break;
    ...
    case 'tracks':
      ...
      BVVIZ.playerTracks( newCards, playerId, true );
      break;
    };
  }
