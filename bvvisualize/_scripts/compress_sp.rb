...
js_libs = [
  "connectors/common/js/jQueryNoConflict.js",
  "common/js/bvviz.js",
  ...
  "sharepoint/behaviors/behaviors.js",
  "sharepoint/communityExpert/communityExpert.js",
  "sharepoint/utility/utility.js",
  "sharepoint/visualization/visualization.js",
  "sharepoint/common/js/start.js"
]

css_libs = [
  "commonLibrary/css/jqueryui.css",
  ...
  "sharepoint/common/css/playerRow.css"
]
...
to_path = "#{viz_des}/bvVisualize_debug.css"
to_file = File.open(to_path, 'a')
...
run "yuicompressor #{viz_des}/bvVisualize_files_debug.js > #{viz_des}/bvVisualize_files.js --nomunge"
puts "  Starting Compress CSS"
run "yuicompressor #{viz_des}/bvVisualize_debug.css > #{viz_des}/bvVisualize.css"
