...
BVVIZ.followingStream = function( target, streamId, playerId, options ) {
  ...
  function init() {
    ...
    BVVIZ.SDKkit.getInstanceBySiteId( settings.siteId ).BVSDK( 'streams', { streams: streamId } ).ok( function( streamData ) {
      ...
      BVVIZ.SDKkit.getInstanceBySiteId( settings.siteId ).BVSDK( 'streams/notifications', { streams: streamId }, {
        fields: 'all',
        source: {
          map: {
            name: 'following',
