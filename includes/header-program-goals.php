					    	...
					    	<ul class="subnav-pages">
								<li class="subnav-page page1"><a href="/pages/goals/progress/?program_id=2&player_id=' . $allPlayerIds[0][1][1] . '">Progress</a>
									<ul class="subnav-subpages">
										<li class="subnav-subpage subpage1"><a href="/pages/goals/progress/leads/?program_id=2&player_id=' . $allPlayerIds[0][1][1] . '">Lead Progress</a></li>
										<li class="subnav-subpage subpage2"><a href="/pages/goals/progress/opportunities/?program_id=2&player_id=' . $allPlayerIds[0][1][1] . '">Oppty Progress</a></li>
										<li class="subnav-subpage subpage3"><a href="/pages/goals/progress/revenue/?program_id=2&player_id=' . $allPlayerIds[0][1][1] . '">Revenue Progress</a></li>
									</ul>
								</li>
					    ...
					    <div class="subnav">
					    	<ul class="subnav-pages">
								<li class="subnav-page page1"><a href="/pages/goals/progress/?program_id=2&player_id=' . $allPlayerIds[1][1][1] . '">Progress</a>
									<ul class="subnav-subpages">
										<li class="subnav-subpage subpage1"><a href="/pages/goals/progress/leads/?program_id=2&player_id=' . $allPlayerIds[1][1][1] . '">Lead Progress</a></li>
										<li class="subnav-subpage subpage2"><a href="/pages/goals/progress/opportunities/?program_id=2&player_id=' . $allPlayerIds[1][1][1] . '">Oppty Progress</a></li>
										<li class="subnav-subpage subpage3"><a href="/pages/goals/progress/revenue/?program_id=2&player_id=' . $allPlayerIds[1][1][1] . '">Revenue Progress</a></li>
									</ul>
								</li>
