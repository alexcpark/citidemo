					...
					$amy_nav = '
					    <div class="subnav">
					    	<ul class="subnav-pages">
								...
								<li class="subnav-page page2"><a href="/pages/guide/types_of_success/?program_id=1&player_id=' . $allPlayerIds[0][1][0] . '">Types of Success</a></li>
					...
					$chris_nav = '
					    <div class="subnav">
					    	<ul class="subnav-pages">
								...
								<li class="subnav-page page2"><a href="/pages/guide/types_of_success/?program_id=1&player_id=' . $allPlayerIds[1][1][0] . '">Types of Success</a></li>
